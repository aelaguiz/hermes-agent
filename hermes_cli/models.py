...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("claude-code-acp", "Claude Code (ACP)",       "Claude Code via `@zed-industries/claude-agent-acp` — uses your Claude Pro/Max OAuth"),
...
_PROVIDER_ALIASES = {
    ...
    "claude-code-cli": "claude-code-acp",
